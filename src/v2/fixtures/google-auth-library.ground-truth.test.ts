/**
 * google-auth-library Ground-Truth Tests
 *
 * Each SHOULD_FIRE / SHOULD_NOT_FIRE annotation in
 * corpus/packages/google-auth-library/fixtures/ground-truth.ts becomes one test case.
 *
 * Postcondition IDs from corpus/packages/google-auth-library/contract.yaml:
 *   get-token-unprotected, get-token-info-unprotected, get-client-unprotected
 *
...
const GROUND_TRUTH_PATH = path.resolve(
  __dirname,
  '../../../../corpus/packages/google-auth-library/fixtures/ground-truth.ts'
);
...
describe('google-auth-library: ground-truth fixture', () => {
