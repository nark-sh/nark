/**
 * tar Ground-Truth Tests
 *
 * Each SHOULD_FIRE / SHOULD_NOT_FIRE annotation in
 * corpus/packages/tar/fixtures/ground-truth.ts becomes one test case.
 *
 * Postcondition IDs from corpus/packages/tar/contract.yaml:
...
const GROUND_TRUTH_PATH = path.resolve(
  __dirname,
  "../../../../nark-corpus/packages/tar/fixtures/ground-truth.ts",
);
...
describe("tar: ground-truth fixture", () => {
