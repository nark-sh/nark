/**
 * rxjs Ground-Truth Tests
 *
 * Each SHOULD_FIRE / SHOULD_NOT_FIRE annotation in
 * corpus/packages/rxjs/fixtures/ground-truth.ts becomes one test case.
 *
 * Postcondition IDs from corpus/packages/rxjs/contract.yaml:
 *   observable-error, empty-completion
 *
...
const GROUND_TRUTH_PATH = path.resolve(
  __dirname,
  "../../../../nark-corpus/packages/rxjs/fixtures/ground-truth.ts",
);
...
describe("rxjs: ground-truth fixture", () => {
