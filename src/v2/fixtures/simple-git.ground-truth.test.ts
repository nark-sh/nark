/**
 * simple-git Ground-Truth Tests
 *
 * Each SHOULD_FIRE / SHOULD_NOT_FIRE annotation in
 * corpus/packages/simple-git/fixtures/ground-truth.ts becomes one test case.
 *
 * Postcondition IDs from corpus/packages/simple-git/contract.yaml:
 *   simple-git-push-missing-try-catch
 *   simple-git-pull-missing-try-catch
 *   simple-git-clone-missing-try-catch
 *   simple-git-merge-missing-try-catch
 *
...
const GROUND_TRUTH_PATH = path.resolve(
  __dirname,
  "../../../../nark-corpus/packages/simple-git/fixtures/ground-truth.ts",
);
...
describe("simple-git: ground-truth fixture", () => {
