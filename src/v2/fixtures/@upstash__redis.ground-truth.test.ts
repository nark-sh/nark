/**
 * @upstash/redis Ground-Truth Tests
 *
 * Each SHOULD_FIRE / SHOULD_NOT_FIRE annotation in
 * corpus/packages/@upstash/redis/fixtures/ground-truth.ts becomes one test case.
 *
 * Postcondition IDs from corpus/packages/@upstash/redis/contract.yaml:
 *   network-or-api-error (applies to all async methods)
 *
...
const GROUND_TRUTH_PATH = path.resolve(
  __dirname,
  '../../../../nark-corpus/packages/@upstash/redis/fixtures/ground-truth.ts'
);
...
describe('@upstash/redis: ground-truth fixture', () => {
