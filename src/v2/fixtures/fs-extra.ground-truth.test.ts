/**
 * fs-extra Ground-Truth Tests
 *
 * Each SHOULD_FIRE / SHOULD_NOT_FIRE annotation in
 * corpus/packages/fs-extra/fixtures/ground-truth.ts becomes one test case.
 *
 * Postcondition IDs from corpus/packages/fs-extra/contract.yaml:
 *   file-not-found, invalid-json, permission-denied (readJson)
 *   source-not-found, permission-denied (copy)
 *   source-not-found, destination-exists, permission-denied (move)
 *
...
const GROUND_TRUTH_PATH = path.resolve(
  __dirname,
  "../../../../nark-corpus/packages/fs-extra/fixtures/ground-truth.ts",
);
...
describe("fs-extra: ground-truth fixture", () => {
