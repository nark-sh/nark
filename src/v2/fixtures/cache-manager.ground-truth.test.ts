/**
 * cache-manager Ground-Truth Tests
 *
 ...
 *   cache-set-bare-await
 *   cache-mset-bare-await
 *   cache-del-bare-await
 *   cache-mdel-bare-await
 *   cache-clear-bare-await
 *   cache-wrap-bare-await
 *   cache-disconnect-bare-await (warning)
 */
...
describe("cache-manager: ground-truth fixture", () => {
