/**
 * @google/genai Ground-Truth Tests
 *
 * Each SHOULD_FIRE / SHOULD_NOT_FIRE annotation in
 * corpus/packages/@google/genai/fixtures/ground-truth.ts becomes one test case.
 *
 * Postcondition IDs from corpus/packages/@google/genai/contract.yaml:
 *   genai-generate-content-error, genai-generate-content-stream-error,
 *   genai-generate-images-error, genai-embed-content-error
 *
...
const GROUND_TRUTH_PATH = path.resolve(
  __dirname,
  '../../../../nark-corpus/packages/@google/genai/fixtures/ground-truth.ts'
);
...
describe('@google/genai: ground-truth fixture', () => {
