/**
 * @google/generative-ai Ground-Truth Tests
 *
 * Each SHOULD_FIRE / SHOULD_NOT_FIRE annotation in
 * corpus/packages/@google/generative-ai/fixtures/ground-truth.ts becomes one test case.
 *
 * Postcondition IDs from corpus/packages/@google/generative-ai/contract.yaml:
 *   network-error, safety-block, stream-chunk-safety-block
 *
...
const GROUND_TRUTH_PATH = path.resolve(
  __dirname,
  '../../../../nark-corpus/packages/@google/generative-ai/fixtures/ground-truth.ts'
);
...
describe('@google/generative-ai: ground-truth fixture', () => {
