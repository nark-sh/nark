/**
 * Axios Ground-Truth Tests
 *
 * Each SHOULD_FIRE / SHOULD_NOT_FIRE annotation in
 * corpus/packages/axios/fixtures/ground-truth.ts becomes one test case.
 *
 * Postcondition IDs from corpus/packages/axios/contract.yaml:
 *   error-4xx-5xx, rate-limited-429, network-failure, request-setup-error
 *
...
const GROUND_TRUTH_PATH = path.resolve(
  __dirname,
  "../../../../corpus/packages/axios/fixtures/ground-truth.ts",
);
...
describe("axios: ground-truth fixture", () => {
